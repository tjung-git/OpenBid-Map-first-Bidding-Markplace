...
\begin{tabularx}{\linewidth}{|l|L|}
\hline
\textbf{Test Case ID} & TC-018e \\ \hline
\textbf{Title} & Profile Page - Prototype KYC Force Pass \\ \hline
\textbf{Requirement} & FR-004 (Prototype Mode) \\ \hline
\textbf{Preconditions} & \texttt{Prototype = TRUE}, user authenticated, KYC pending. \\ \hline
\textbf{Steps} & 
\begin{minipage}[t]{\linewidth}
\begin{enumerate}[leftmargin=1.4em,nosep,topsep=0pt]
  \item User clicks "Complete KYC" button.
  \item System detects prototype mode.
  \item System calls \texttt{/api/kyc/force-pass} endpoint.
  \item System updates user session with verified status.
\end{enumerate}
\end{minipage} \\ \hline
\textbf{Expected Result} & KYC status immediately updated to \texttt{verified}; session updated. \\ \hline
\textbf{Actual Result} & Passed - Force pass works correctly in prototype mode. \\ \hline
\textbf{Status} & \textcolor{green}{Passed} \\ \hline
\textbf{Priority} & Medium \\ \hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{|l|L|}
\hline
\textbf{Test Case ID} & TC-018f \\ \hline
...
\begin{tabularx}{\linewidth}{|l|L|}
\hline
\textbf{Test Case ID} & TC-019c \\ \hline
...
\begin{tabularx}{\linewidth}{|l|L|}
\hline
\textbf{Test Case ID} & TC-019d \\ \hline
