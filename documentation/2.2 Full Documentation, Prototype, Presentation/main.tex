...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item Update core authentication and authorization funtionality of the prototype- specifically authentication and security flows: \textbf{auth + Duo 2FA} and \textbf{KYC gate} (stubbed via Stripe Identity sandbox token).
  ...
  \item Update documentation- reiterate user stories, update functional and non-functional requirements, and provide a user manual.
...
\subsubsection{Prototype Requirements (Focus for this iteration)}
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item \textbf{Bidding:} Contractors shall place, edit, and withdraw bids (amount, note, ETA). Posters can post jobs.
\end{enumerate}
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item \textbf{Updated Bidding:} Contractors shall place, edit, and withdraw bids (amount, note, ETA) and Posters can post jobs \textbf{and} accept a winning bid.
  \item \textbf{Two-Factor Authentication (2FA):} Users shall sign-in with Duo 2FA.
...
\textbf{Most non-functional requirements will not be implemented in the prototype (only in the production application).}
\begin{enumerate}[leftmargin=1.4em]
