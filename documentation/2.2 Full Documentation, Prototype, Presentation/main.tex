...
\begin{itemize}[leftmargin=1.4em]
  \item \textbf{Post a job}, \textbf{browse on map}, \textbf{place a bid} core bidding functionality should be fully implemented in the prototype.
...
As a \textbf{Contractor}, I want to place a bid with amount, note, and ETA so the Job Poster can evaluate me.
\begin{itemize}[leftmargin=1.4em]
...
\textbf{At this time, it was determined that it would be difficult to implement tests for the scalability, reliability and privacy non-FRs. Test cases will be planned and implemented in a future iteration.}
\begin{longtable}{@{}p{0.12\linewidth} p{0.55\linewidth} p{0.2\linewidth} p{0.14\linewidth}@{}}
\toprule
\textbf{Req ID} & \textbf{Requirement Description} & \textbf{Test Case IDs} & \textbf{Coverage} \\
\midrule
