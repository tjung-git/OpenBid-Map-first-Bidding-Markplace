...
\begin{itemize}[leftmargin=1.4em]
  \item \textbf{Week 1:} Implement auth + Duo 2FA hook, KYC gate stub, Post Job UI/API, initial tests.
  \item \textbf{Week 2:} Map browse (pins, filters), Place Bid flow, tests.
  \item \textbf{Week 3:} Prototype hardening, accessibility pass (keyboard focus), performance harness scaffolding, test documentation.
\end{itemize}
