...
job bidder is the user first browses for jobs, then bids on a job, then the bid is either accepted, rejected or close (if the job closes). The general user journey
