...
% ===================== 9. Next Steps =====================
\section{\textbf{Next Steps:} Prototype -> Production application (MVP)}
\textbf{Future Refined Stack (MVP):} React + SCSS (Firebase Hosting), Node.js + Express (Firebase Functions or Cloud Run), Firestore, Google Maps JS, Stripe (Connect/Identity), Duo 2FA.

\subsection{Implemented in a future iteation (target)}
The following features will be implemented and/or refined.
\begin{itemize}[leftmargin=1.4em]
