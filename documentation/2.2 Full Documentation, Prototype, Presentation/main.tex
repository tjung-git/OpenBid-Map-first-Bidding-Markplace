...
% ===================== 5. User Manual =====================
\section{User Manual}
\subsection{Running the prototype application}
...
\subsection{Using the prototype application}

\section{Prototype Overview}
\subsection{Protoype Description}
This prototype highlights the core functionality of the OpenBid Application. Authenticated users can browse job postings from job posters as
