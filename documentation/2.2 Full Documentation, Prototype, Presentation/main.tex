...
a job browser. Users that complete KYC verification can additionally bid on jobs as a job bidder and create jobs as a job poster. The prototype uses in memory
mocks to store persistent data and control API route flow.
