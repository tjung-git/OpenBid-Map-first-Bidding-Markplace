...
describe("Profile - KYC Integration", () => {
  ...
  describe("KYC Status Display", () => {
    it("displays pending KYC status", async () => {
      ...
      expect(
        screen.getByText("Identity Verification (KYC)"),
      ).toBeInTheDocument();
      await waitFor(() => {
  ...
  describe("KYC Verification Flow", () => {
    it("calls kycVerification API when Complete KYC is clicked", async () => {
      api.api.kycVerification.mockResolvedValue({
        url: "https://stripe.com/verify",
      });
    ...
    it("opens Stripe URL in new tab in production mode", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/KYC verification opened in new tab/),
        ).toBeInTheDocument();
      });
  ...
  describe("KYC Status Refresh", () => {
    ...
    it("handles refresh error gracefully", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Failed to check KYC status"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Avatar Upload", () => {
    ...
    it("uploads avatar successfully", async () => {
      ...
      api.api.uploadAvatar.mockResolvedValue({
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText("Avatar updated successfully!"),
        ).toBeInTheDocument();
      });
    });
